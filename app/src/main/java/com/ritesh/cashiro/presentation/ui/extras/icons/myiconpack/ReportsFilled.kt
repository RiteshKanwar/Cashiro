...
public val MyIconPack.ReportsFilled: ImageVector
    get() {
        if (_reportsFilled != null) {
            return _reportsFilled!!
        }
        _reportsFilled = Builder(name = "ReportsFilled", defaultWidth = 24.0.dp, defaultHeight =
...
private var _reportsFilled: ImageVector? = null
