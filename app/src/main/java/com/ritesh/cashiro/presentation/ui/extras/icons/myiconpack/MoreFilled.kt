...
public val MyIconPack.MoreFilled: ImageVector
    get() {
        if (_moreFilled != null) {
            return _moreFilled!!
        }
        _moreFilled = Builder(name = "MoreFilled", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _moreFilled: ImageVector? = null
